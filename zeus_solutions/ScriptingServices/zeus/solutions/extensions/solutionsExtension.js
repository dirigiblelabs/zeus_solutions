/*
	Extension for the '/zeus_solutions/solutions_database_crud_hooks' Extension Point!
...
exports.beforeCreate = function(connection, entity) {
	console.log('Before creating new entity \'' + entity + '\' in table \'ZEUS_SOLUTIONS\'');
};

exports.afterCreate = function(connection, entity) {
	console.log('After creating new entity \'' + entity + '\' in table \'ZEUS_SOLUTIONS\'');
};

exports.beforeUpdate = function(connection, entity) {
	console.log('Before updating table \'ZEUS_SOLUTIONS\' with entity \'' + entity + '\'');
};

exports.afterUpdate = function(connection, entity) {
	console.log('After updating table \'ZEUS_SOLUTIONS\' with entity \'' + entity + '\'');
};

exports.beforeDelete = function(connection, entity) {
	console.log('Before deleting entity \'' + entity + '\' from table \'ZEUS_SOLUTIONS\'');
};

exports.afterDelete = function(connection, entity) {
	console.log('After deleting entity \'' + entity + '\' from table \'ZEUS_SOLUTIONS\'');
};
